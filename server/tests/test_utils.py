...
@pytest.mark.parametrize('current_offset, current_pagesize, count, \
    expected_prev_pagination, expected_next_pagination', [
...
def test_get_next_prev_paginations_gives_expected_output(
