...
function VerbForm({
  ...
  return (
    <div className="VerbForm">
      <div className="VerbForm-name">{verbFormName}</div>
      <div className="VerbForm-value">{verbFormValue}</div>
    </div>
  );
}

function VerbForms({ verbForms }: { verbForms: VerbFormsType }) {
  const {
    verb_type,
    perfect,
    imperative,
  ...
  return (
    <div className="VerbForms">
      <div className="VerbForms-header">Verb Forms</div>
      <div className="VerbForms-items">
        ...
        <VerbForm
          verbFormName="Active Participle"
          verbFormValue={active_participle}
        />
        <VerbForm
          verbFormName="Passive Participle"
          verbFormValue={passive_participle}
        />
